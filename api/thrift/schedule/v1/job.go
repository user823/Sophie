...
func (p *JobInfo) GetCreateTime() (v string) {
	return p.CreateTime
}
...
func (p *JobInfo) GetUpdateTime() (v string) {
	return p.UpdateTime
}
...
func (p *JobInfo) SetCreateTime(val string) {
	p.CreateTime = val
}
func (p *JobInfo) SetUpdateBy(val string) {
	p.UpdateBy = val
}
func (p *JobInfo) SetUpdateTime(val string) {
	p.UpdateTime = val
}
...
func (p *JobInfo) Field2DeepEqual(src string) bool {
...
type JobLog struct {
	...
	StopTime      string `thrift:"stopTime,9" frugal:"9,default,string" json:"stopTime"`
...
func (p *JobLog) GetStartTime() (v string) {
	return p.StartTime
}

func (p *JobLog) GetStopTime() (v string) {
	return p.StopTime
}

func (p *JobLog) GetCreateTime() (v string) {
	return p.CreateTime
}
...
func (p *JobLog) SetStartTime(val string) {
	p.StartTime = val
}
func (p *JobLog) SetStopTime(val string) {
	p.StopTime = val
}
func (p *JobLog) SetCreateTime(val string) {
	p.CreateTime = val
}
...
func (p *JobLog) writeField9(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("stopTime", thrift.STRING, 9); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.StopTime); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *JobLog) Field9DeepEqual(src string) bool {

	if strings.Compare(p.StopTime, src) != 0 {
		return false
	}
	return true
}
func (p *JobLog) Field10DeepEqual(src string) bool {
