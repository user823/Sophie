...
type GenTableStore interface {
	// 查询业务列表
	SelectGenTableList(ctx context.Context, table *v1.GenTable, opts *api.GetOptions) ([]*v1.GenTable, int64, error)
	// 查询数据库列表
	SelectDbTableList(ctx context.Context, table *v1.GenTable, opts *api.GetOptions) ([]*v1.GenTable, int64, error)
	// 查询数据库列表
	SelectDbTableListByNames(ctx context.Context, tableNames []string, opts *api.GetOptions) ([]*v1.GenTable, int64, error)
	// 查询所有表信息
	SelectGenTableAll(ctx context.Context, opts *api.GetOptions) ([]*v1.GenTable, int64, error)
	// 查询表id业务信息
