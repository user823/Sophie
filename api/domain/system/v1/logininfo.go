...
type SysLogininfor struct {
	InfoId     int64     `json:"infoId,omitempty" gorm:"column:info_id" query:"infoId"`
	UserName   string    `json:"userName,omitempty" gorm:"column:user_name" query:"userName"`
	Ipaddr     string    `json:"ipaddr,omitempty" gorm:"column:ipaddr" query:"ipaddr"`
	Status     string    `json:"status,omitempty" gorm:"column:status" query:"status"`
	Msg        string    `json:"msg,omitempty" gorm:"column:msg" query:"msg"`
	AccessTime time.Time `json:"accessTime,omitempty" gorm:"access_time" query:"accessTime"`
}
