...
type Options struct {
	...
	LoadBalance        *loadbalance.LoadBalanceOptions `json:"loadbalance" mapstructure:"loadbalance"`
...
func NewOptions() *Options {
	return &Options{
		...
		LoadBalance:        loadbalance.NewLoadBalanceOptions(),
...
func (o *Options) Flags() *ds.FlagGroup {
	...
	o.LoadBalance.AddFlags(fss.FlagSet("loadbalance"))
