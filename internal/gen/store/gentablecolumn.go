...
type GenTableColumnStore interface {
	// 根据表名称查询列信息
	SelectDbTableColumnsByName(ctx context.Context, tableName string, opts *api.GetOptions) ([]*v1.GenTableColumn, int64, error)
	// 查询业务字段列表
	SelectGenTableColumnListByTableId(ctx context.Context, tableId int64, opts *api.GetOptions) ([]*v1.GenTableColumn, int64, error)
	// 新增业务字段
