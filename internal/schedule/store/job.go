...
type JobStore interface {
	// 查询调度任务日志集合
	SelectJobList(ctx context.Context, job *v1.SysJob, opts *api.GetOptions) ([]*v1.SysJob, int64, error)
	// 查询所有调度任务
	SelectJobAll(ctx context.Context, opts *api.GetOptions) ([]*v1.SysJob, int64, error)
	// 通过调度ID查询调度任务信息
	SelectJobById(ctx context.Context, jobId int64, opts *api.GetOptions) (*v1.SysJob, error)
	// 通过调度ID查询调度任务信息
	SelectJobByIds(ctx context.Context, JobIds []int64, opts *api.GetOptions) ([]*v1.SysJob, int64, error)
	// 批量删除调度任务信息
